 ...
 */
public class GearAimingParameters {
    double range;
    ...
    public GearAimingParameters(double range, Rotation2d robot_to_goal, Rotation2d field_to_goal, double last_seen_timestamp,
            double stability) {
        this.range = range;
